...
var adapterRun = adapter.adapterRun,
	...
	if(window.location.href.indexOf("-en") > -1) {
		creditText = "Source: tilastot.kirjastot.fi";
	} else if (window.location.href.indexOf("-sv") > -1) {
		creditText = "Källa: tilastot.kirjastot.fi/sv-FI/";
	} else {
		creditText = "Lähde: hankkeet.kirjastot.fi";
}
...
// fixi, joka ottaa huomioon export-nappulan leveyden kartassa (mikä on oikeasti noin 75px tekstin kanssa) äää
                                    //         console.log(window.PAGE.TYPE)
                                    if (window.PAGE.TYPE === "map") {
                                        tooLong = actualWidth > width - 100;
                                    } else {
