...
(function($, undefined) {
   ...
   var linkDefaults = {
      ...
      'uncheckAll': {
         ...
         'text': _(' Tyhjennä kaikki valinnat'),
         'title': _(' Tyhjennä kaikki valinnat'),
      },
      'flipAll': {
  ...
  function getjQueryFromElement(elem) {
   ...
   options: {
      ...
      noneSelectedText: _('Suodata avustuksia'), // (string | null) The text to show in the button where nothing is selected.  Set to null to use the native select's placeholder text.
  //    selectedText: '# of # selected', // (string) A "template" that indicates how to show the count of selections in the button.  The "#'s" are replaced by the selection count & option count.
      selectedText: _('Valittuna')+' #/#', // (string) A "template" that indicates how to show the count of selections in the button.  The "#'s" are replaced by the selection count & option count.
   ...
   _makeOption: function(option) {
    ...
    _buildOptionList: function() {
      ...
      //    var $optGroupLabel = $( document.createElement('a') )
            //ää oma lisäys
            var $optGroup_i_item = $( document.createElement('i') )
                .addClass('fa').addClass('fa-angle-down').addClass('right')

          var $optGroupLabel = $( document.createElement('a') )
                                    .addClass('collapseri') // oma lisäys
                                    .addClass('ui-multiselect-grouplabel'
                                      + (self.options.groupsSelectable ? ' ui-multiselect-selectable' : ''))
                                    .attr({'tabindex': 0}) // oma lisäys
                                    .html( elem.getAttribute('label') );
        //    $optGroupLabel.href = "https://google.com"
            $optGroupLabel.append($optGroup_i_item)
          var $optionGroup = $( document.createElement('ul') ).append(options);
          var $optGroupItem = $( document.createElement('li') )
                                 .addClass('ui-multiselect-optgroup'
                                    + (self.options.groupColumns ? ' ui-multiselect-columns' : '')
                                    + (elem.className ? ' ' + elem.className : ''))
                          //      .addClass('ui-multiselect-collapsed') // äää oma lisäys
    ...
    _bindCheckboxEvents: function() {
      ...
      /*    .on('keyup', function(e) {
       ...
       //           self._trigger('collapsetoggle', e, {label: optgroupLabel, collapsed: !isCollapsed});
          ...
          .on('click.multiselect','.collapseri','keyup.multiselect', function(e) {
              var $this = $(this);

              var $parent = $this.parent();
              var optgroupLabel = $parent.find('.ui-multiselect-grouplabel').first().html();
              var collapseSign = $parent.find('.ui-multiselect-collapser');
              var collapse_i_SignDown = $parent.find('.fa-angle-down');
              var collapse_i_SignUp = $parent.find('.fa-angle-up');
              var linkInfo = self.linkInfo;
              var collapsedClass = 'ui-multiselect-collapsed';
              var isCollapsed = $parent.hasClass(collapsedClass);
          ...
          //    collapseSign.attr('title', isCollapsed ? linkInfo.collapse.title : linkInfo.expand.title)
              collapseSign.html(isCollapsed ? linkInfo.collapse.icon : linkInfo.expand.icon );
              if(collapse_i_SignDown) {
                  collapse_i_SignDown.removeClass("fa-angle-down")
                  collapse_i_SignDown.addClass("fa-angle-up")
              }
              if(collapse_i_SignUp) {
                  collapse_i_SignUp.removeClass("fa-angle-up")
                  collapse_i_SignUp.addClass("fa-angle-down")
              }
