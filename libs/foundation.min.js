...
(function (e, t, n, r) {
    ...
    Foundation.libs.dropdown = {
        ...
        version: "5.1.1",
        settings: {
            active_class: "open", is_hover: !1, opened: function () {
            }, closed: function () {
            }
        },
        init: function (e, t, n) {
        ...
        css: function (e, n) {
            ...
            }), e.css(Foundation.rtl ? "right" : "left", "2.5%"); else {
    ...
    Foundation.libs.tooltip = {
        ...
        events: function () {
            ...
            Modernizr.touch ? r(n).off(".tooltip").on("click.fndtn.tooltip touchstart.fndtn.tooltip touchend.fndtn.tooltip", "[" + this.attr_name() + "]:not(a)", function (n) {
                ...
                e.preventDefault(), r(this).fadeOut
                (150)
    ...
    "use strict";
    Foundation.libs.tab = {
        name: "tab", version: "5.1.1", settings: {
    ...
    "function" == typeof define && define.amd ? define(["jquery.min"], e) : e(jQuery)
}(function (e) {
    function t(e) {
    ...
    Foundation.libs.offcanvas = {
        name: "offcanvas", version: "5.1.1", settings: {}, init: function (e, t, n) {
            this.events()
        }, events: function () {
            var e = this.S;
